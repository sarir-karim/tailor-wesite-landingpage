            ...
            <div className="bg-[#E6F4EF] p-10 flex mt-20 sec6main">
                <div className="w-[50%] sec6left">
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <p className='w-[60%] text-center font-[500]'>Get ahead of the competition with
                                customized designer clothing for your brand </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="w-[50%] sec6right">
                    <div className="flex items-center justify-center">
                        <div className="max-w-md w-full py-6 px-14 bg-white rounded-lg shadow-lg">
